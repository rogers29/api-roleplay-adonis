...
test.group('Group', (group) => {
  test('it should creat a group', async (assert) => {
  ...
  test('it should update a group', async (assert) => {
    ...
    // O "Put" é utilizado quando todo o payload será atualizado
    // O "Patch" é utilizado quando apenas parte dele pode ser atualizado.
    const { body } = await supertest(BASE_URL)
