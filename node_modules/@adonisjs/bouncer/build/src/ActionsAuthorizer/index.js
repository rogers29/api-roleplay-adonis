...
class ActionsAuthorizer {
    ...
    async runHooks(lifecycle, action, result, args, profiler) {
        ...
        for (let hook of this.bouncer.hooks[lifecycle]) {
             ...
             */
            if ((0, utils_2.hookHasHandledTheRequest)(response)) {
                break;
            }
        }
        return (0, utils_2.normalizeHookResponse)(response);
    }
    /**
     * Run the action
     */
    async runAction(action, args, profiler) {
        ...
        if (!this.user && !allowGuest) {
            return (0, utils_2.normalizeActionResponse)(false);
        }
        /**
        ...
        return (0, utils_2.normalizeActionResponse)(response);
    }
    /**
    ...
    async authorizeAction(action, args) {
        ...
        try {
            ...
            if (beforeStatus !== 'skipped') {
                return profiler.end((0, utils_2.normalizeActionResponse)(beforeStatus === 'authorized' ? true : false));
            }
            /**
             * Run action handler
             */
            ...
            if (afterStatus !== 'skipped') {
                return profiler.end((0, utils_2.normalizeActionResponse)(afterStatus === 'authorized' ? true : false));
            }
