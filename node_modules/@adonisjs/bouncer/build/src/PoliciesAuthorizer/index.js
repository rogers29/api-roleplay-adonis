...
class PoliciesAuthorizer {
    ...
    async runHooks(lifecycle, action, result, args, profiler) {
        ...
        return (0, utils_1.normalizeHookResponse)(response);
    }
    /**
     * Run the action
     */
    async runAction(action, args, profiler) {
        ...
        if (!this.user && !allowGuest) {
            return (0, utils_1.normalizeActionResponse)(false);
        }
        /**
        ...
        return (0, utils_1.normalizeActionResponse)(response);
    }
    /**
    ...
    async authorizeAction(action, args) {
        ...
        try {
            ...
            if (beforeStatus !== 'skipped') {
                return profiler.end((0, utils_1.normalizeActionResponse)(beforeStatus === 'authorized' ? true : false));
            }
            /**
             * Run action handler
             */
            ...
            if (afterStatus !== 'skipped') {
                return profiler.end((0, utils_1.normalizeActionResponse)(afterStatus === 'authorized' ? true : false));
            }
